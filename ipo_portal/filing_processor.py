...
11. Prefer concise, high-signal facts that help a reader understand the company, issue, risks, industry, financials, valuation, and red flags.
"""
...
SECTION_SPECS: list[dict[str, Any]] = [
    ...
    {
        "name": "offer",
        "keywords": ["THE ISSUE", "OBJECTS OF THE OFFER", "OBJECTS OF THE ISSUE", "THE OFFER"],
        "min_page": 20,
        "pages_after": 40,
        "schema": {
