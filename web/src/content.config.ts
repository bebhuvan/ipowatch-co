...
// IPO research reports — long-form, page-cited analyses of a single
// filing, generated by ipo_portal.orchestrator.ipo_report. One file per
// issue, rendered at /ipos/<issue_slug>/report.
const ipoReports = defineCollection({
  loader: glob({ pattern: '**/*.md', base: './src/content/ipo-reports' }),
  schema: z.object({
    slug: z.string(),
    issue_slug: z.string(),
    company_name: z.string(),
    document_type: z.string(),
    report_type: z.string().default('ipo-research'),
    kicker: z.string(),
    title: z.string(),
    dek: z.string(),
    reading_time_minutes: z.number(),
...
export const collections = { academy, ipoReports };
